public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Masha teper poluchaet " + zpMashaNew + " rub. Godovoy dohod vyros na " + yearUpWageMasha + " rub.");
        System.out.println("Denis teper poluchaet " + zpDenisNew + " rub. Godovoy dohod vyros na " + yearUpWageDenis + " rub.");
        System.out.println("Kristina teper poluchaet " + zpKristinaNew + " rub. Godovoy dohod vyros na " + yearUpWageKristina + " rub.");
    }
}